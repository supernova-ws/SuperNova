...
2. Полет A --> B
   ...
   b) скан A => можно увидеть время возвращения флота (но не  его  прибытия  на
   B)
3. Возвращение B --> A
...
При старте движка он грузит все PHP файлы из  каталога  /modules/_functions.  В
этих файлах должны содержатся  альтернативные  функции  и  указания  движку  на
включения перекрытия. См.  файл  /modules/_functions/_example.php  для  примера
перекрытия функции display() с последующим вызовом стандартной функции
...
работу СН начиная с v33a12! Обновите PHP, сделайте откат до более ранней версии
PHP или используйте предыдущую версию СН.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Updated: 2011-12-27 16:07 Project "SuperNova.WS" Release 32
