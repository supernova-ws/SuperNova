...
10.000 ТМ для галактики и 10.00  ТМ  для  системы  -  т.н.  "базовую  стоимость
...
------------------------------------------------
На странице настроке пользователя можно указать, сколько колонок должно быть  в
...
с списке - см. соответствующий пункт там же. В этом  случае  движок  рассчитает
