...
Временные наемники
------------------
Добавлена поддержка  временных  Наемников  (ВН).  Тип  Наемников  выбирается  в
настройках сервера
...
2592000 секунд). Изменить БПН можно на странице настроек сервера
...
теряется. Страница покупки губернаторов требует подтверждение операции
при покупке губернатора, отличного от текущего.
...
БС 800, Фактор 1.06, нет ограничения по уровням. Стоимость 20 уровня - 29418 ТМ

"Инженер"  объединяет  функции  Архитектора  и  Конструктора:  каждый   уровень
уменьшает время постройки зданий  и  кораблей  на  5%.
БС 400, Фактор 1.25, максимальный уровень 15. Стоимость 10-го  уровне  -  13298
ТМ, 15-го - 43868 ТМ

"Фортификатор" играет для планеты роль Защитника: каждый уровень  уменьшает  на
10% время постройки защитных сооружений и ракет, а так же  на  10%  увеличивает
атаку, броню и защиту флотов хозяина при обороне  планеты  -  включая  наземные
сооружения. Фортификатор 3го уровня позволяет строить  Планетарную  защиту.
БС 2000, Фактор 1, максимальный уровень 8. Стоимость 8-го уровня - 16000 ТМ
...
--------------------
Текущие уровни активных Наемников.
...
но и их качество. Время постройки нормированы  по  дейтрию,  т.е.  постройки  с
...
Исследования  теперь  могут  производится  даже  на  планетах  со   строящимися
лабораториями/нанолабораториями
В случае отсутствия МИС для проведения исследования  выбирается  лаборатория  с
максимальным эффективным уровнем (т.е. с учетом нанолабораторий)
...
game_noob_points (по  умолчанию  5000)  считаются  "начинающими"  игроками.  На
...
количество одного или любой комбинации ресурсов: металл, кристалл, дейтрий  или
...
Счет Альянса
------------
Каждый Альянс имеет счет с ресурсами металл/кристалл/дейтрий/ТМ
...
умолчанию, задается в таблице `config` записью 'ali_members_bonus') каждый член
...
3. Мин.размер порядка 12 - для больших серверов со  околостандартной  скоростью
   игры (1x-3x).
...
Навбары
=======
Из глобального навбара убрано количество текущих ресурсов на планете/в  альянсе
- их присутствие на большей части экранов не  имело  практического  смысла  при
том, что отнимало драгоценное вертикальное пространство страницы.
...
т.е. будет полностью восстановлен функционал старого глобального навбара
Там, где сведения о количестве ресурсов на планете смысл имеет - они  добавлены
или включен планетарный навбар
...
10000 ТМ для галактики  и  1000  ТМ  для  системы  -  т.н.  "базовую  стоимость
...
Пример
Пусть базовая цена именования системы составляет 1000 ТМ.
Первый игрок решил переименовать систему  без  названия.  Он  мог  бы  уплатить
базовую стоимость в 1000 ТМ, однако решил уплатить 2500 ТМ
Теперь цена переименования системы для следующего игрока составит
  <Текущая цена имени> + <Базовая цена> = 2500 + 1000 = 3500 ТМ
...
Аватары
=======
Для корректной работы подсистемы аватаров в PHP должен быть корректно  настроен
временный  каталог  и  движку  должна   быть   разрешена   запись   в   каталог
/images/avatar
...
БД
==
[@] Добавлен патч для  mysql-серверов  со  включенным  STRICT_TRANS_TABLES  при
    отправке флотов
...
Если CURL не  установлен,  будет  осущствлена  попытка  получить  версию  через
...
1. Полный URL сервера - т.е. HTTP-адрес и подкаталог  сервера.  Это  необходимо
   ...
   различать несколько копий СверхНовой, установленных на одном IP или домене.
...
------------------------
Зачем  вообще  регистрировать  свой  сервер?   В   будующем   планируется   ряд
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Updated: 2012-03-03 21:57 Project "SuperNova.WS" Release 33
