...
(добавлено в дистрибутив, файл  /docs/coding-guidelines/coding-guidelines.html)
с одним исключением: табуляция  расширяются  в  два  пробела  и  заменяются  по
возможности на пробелы
