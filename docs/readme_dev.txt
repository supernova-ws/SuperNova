...
заменяются по возможности на пробелы. Выделяются два уровня совместимости:  PCG
или PCG0 - код отформатирован в соответствии с PCG; PCG1 - включает PCG0, а так
же  означает,  что  переменные  названы  в  соответствии  с  PCG  и   правильно
расставлены одинарные и двойные кавычки

Движок использует phpBB3 Tepmlate Engine (далее - PTE). PTE доработан до полной
...
в PCG и на форумах  поддержки  phpBB3.  Единственное  исключение  -  шаблоны  в
настоящее время имеют расширение .TPL, а не .HTML, как в оригинальном PTE
...
-------------------------
  ...
  303 - Пользователь не найден в системе. Это может означать, что  пользователь
        на странице логина или регестрируется. Или это может означать ошибку
  304 - Колонизация с несколькими кораблями
  305 - Попытка  взлома.  Пользователь   попытался   передать   отрицательное
        количество ресурсов на странице  Черного  Рынка/Торговец  ресурсами.  В
        нормальных условиях это сделать невозможно
  ...
  402 - Ошибка изменения количества Темной Материи
  403 Forbidden
  404 Not Found
