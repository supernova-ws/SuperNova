...
$template->assign_vars(array(
  ...
  'CHECK_RESULT' => isset($lang['adm_opt_ver_response'][classSupernova::$config->server_updater_check_result]) ? $lang['adm_opt_ver_response'][classSupernova::$config->server_updater_check_result] : $lang['adm_opt_ver_response'][SNC_VER_UNKNOWN_RESPONSE],
...
//  'STATS_HIDE_PLAYER_LIST' => classSupernova::$config->stats_hide_player_list,
...
//    'SELECTED' => $lang_id == classSupernova::$config->game_default_language ? 'SELECTED' : '',
  ));
}
