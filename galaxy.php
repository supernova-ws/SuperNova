...
$POST_galaxyLeft  = intval($_POST["galaxyLeft"]);
$POST_galaxyRight = intval($_POST["galaxyRight"]);
$POST_systemLeft  = intval($_POST["systemLeft"]);
$POST_systemRight = intval($_POST["systemRight"]);
