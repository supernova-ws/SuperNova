...
function sn_function_call($func_name, $func_arg = array())
{
  ...
  if(is_array($functions[$func_name]) && !is_callable($functions[$func_name]))
  {
    ...
    {
      // РџРѕ РёРґРµРµ - СЌС‚Рѕ СѓР¶Рµ С‚СѓС‚ РЅРµ РЅСѓР¶РЅРѕ, РїРѕС‚РѕРјСѓ С‡С‚Рѕ РѕРЅРѕ РІСЃРµ РґРѕР»Р¶РЅРѕ Р±С‹С‚СЊ callable Рє СЌС‚РѕРјСѓ РјРѕРјРµРЅС‚Сѓ
      // РќРѕ РґР»СЏ СЃС‚Р°СЂС‹С… РјРѕРґСѓР»РµР№...
...
// ----------------------------------------------------------------------------------------------------------------
//
// Routine Test de validitР“В© d'une adresse email
//
