...
function flt_mission_transport($fleet_row)
{
  ...
  if ($fleet_row['fleet_mess'] == 0 && $fleet_row['fleet_start_time'] <= $time_now)
  {
    ...
    return RestoreFleetToPlanet($fleet_row, false, false);
  }
  elseif($fleet_row['fleet_mess'] != 0 && $fleet_row['fleet_end_time'] <= $time_now)
  {
