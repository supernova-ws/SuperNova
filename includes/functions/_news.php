...
function nws_render(&$template, $query_where = '', $query_limit = 20) {
  ...
  while($announce = db_fetch($announce_list)) {
    ...
    $announce_exploded = explode("<br /><br />", BBCodeParser::parseStatic($announce['strAnnounce'], intval($announce['authlevel'])));
    ...
    $template->assign_block_vars('announces', array(
      ...
      'ANNOUNCE'        => BBCodeParser::parseStatic($announce['strAnnounce'], intval($announce['authlevel'])),
