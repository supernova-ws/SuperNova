...
#############################################################################
*/
function flt_mission_destroy($fleet_row, $source_user, $source_planet, $destination_user, $destination_planet)
{
  $result = flt_mission_attack($fleet_row, $source_user, $source_planet, $destination_user, $destination_planet);

  if(empty($result)) return;
  if ($result['won'] != 1) return $result;
