...
function sn_user_birthday_celebrate()
{
  ...
  while($row = db_fetch($query))
  {
    ...
    msg_send_simple_message($row['id'], 0, SN_TIME_NOW, MSG_TYPE_ADMIN, classLocale::$lang['sys_administration'], classLocale::$lang['sys_birthday'], sprintf(classLocale::$lang['sys_birthday_message'], $row['username'], $row['current_birthday'], $config->user_birthday_gift, classLocale::$lang['sys_dark_matter_sh']), true, true);
  }
