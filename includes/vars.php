...
*/
    ...
    'planet_density' => array(
      ...
      PLANET_DENSITY_ICE_HYDROGEN => array(
        ...
        UNIT_PLANET_DENSITY_RARITY => 1, // 40.00, // * 1/121 0,82645
        UNIT_PLANET_DENSITY_RICHNESS => PLANET_DENSITY_RICHNESS_PERFECT,
        UNIT_RESOURCES => array(RES_METAL => 0.30, RES_CRYSTAL => 0.30, RES_DEUTERIUM => 2.40, ),
      ...
      PLANET_DENSITY_ICE_METHANE => array(
        ...
        UNIT_PLANET_DENSITY_RARITY =>  6, // 6.67, // * 6,0	4,95868
        UNIT_PLANET_DENSITY_RICHNESS => PLANET_DENSITY_RICHNESS_GOOD,
        UNIT_RESOURCES => array(RES_METAL => 0.60, RES_CRYSTAL => 0.80, RES_DEUTERIUM => 1.50, ),
      ...
      PLANET_DENSITY_ICE_WATER => array(
        ...
        UNIT_PLANET_DENSITY_RARITY =>  20, // 2.00, // * 20,0	16,52893
        UNIT_PLANET_DENSITY_RICHNESS => PLANET_DENSITY_RICHNESS_AVERAGE,
        UNIT_RESOURCES => array(RES_METAL => 0.90, RES_CRYSTAL => 0.95, RES_DEUTERIUM => 1.10, ),
      ...
      PLANET_DENSITY_CRYSTAL_RAW => array(
        ...
        UNIT_PLANET_DENSITY_RARITY => 1, // 40.00, // *1,0	0,82645
        UNIT_PLANET_DENSITY_RICHNESS => PLANET_DENSITY_RICHNESS_PERFECT,
        UNIT_RESOURCES => array(RES_METAL => 0.40, RES_CRYSTAL => 4.00, RES_DEUTERIUM => 0.60, ),
        UNIT_PLANET_DENSITY_MAX_SECTORS => 150,
      ),
      PLANET_DENSITY_CRYSTAL_SILICATE => array(
        UNIT_PLANET_DENSITY => 3500,
        UNIT_PLANET_DENSITY_INDEX => PLANET_DENSITY_CRYSTAL_SILICATE,
        UNIT_PLANET_DENSITY_RARITY => 7, // 5.71, // * 7,0	5,78512
        UNIT_PLANET_DENSITY_RICHNESS => PLANET_DENSITY_RICHNESS_GOOD,
        UNIT_RESOURCES => array(RES_METAL => 0.80, RES_CRYSTAL => 2.00, RES_DEUTERIUM => 0.85, ),
        UNIT_PLANET_DENSITY_MAX_SECTORS => 200,
      ),
      PLANET_DENSITY_CRYSTAL_STONE => array(
        UNIT_PLANET_DENSITY => 4750,
        UNIT_PLANET_DENSITY_INDEX => PLANET_DENSITY_CRYSTAL_STONE,
        UNIT_PLANET_DENSITY_RARITY => 21, // 1.90, // * 21,0	17,35537
        UNIT_PLANET_DENSITY_RICHNESS => PLANET_DENSITY_RICHNESS_AVERAGE,
        UNIT_RESOURCES => array(RES_METAL => 0.90, RES_CRYSTAL => 1.25, RES_DEUTERIUM => 0.95, ),
        UNIT_PLANET_DENSITY_MAX_SECTORS => 999,
      ),
      ...
      PLANET_DENSITY_STANDARD => array(
        ...
        UNIT_PLANET_DENSITY_RARITY => 40, // 1.0, // * 40,0	33,05785
      ...
      PLANET_DENSITY_METAL_ORE => array(
        ...
        UNIT_PLANET_DENSITY_RARITY => 19, // 2.11, // * 19,0	15,70248
        UNIT_PLANET_DENSITY_RICHNESS => PLANET_DENSITY_RICHNESS_AVERAGE,
        UNIT_RESOURCES => array(RES_METAL => 1.50, RES_CRYSTAL => 0.90, RES_DEUTERIUM => 0.95, ),
        UNIT_PLANET_DENSITY_MAX_SECTORS => 150,
      ),
      PLANET_DENSITY_METAL_PERIDOT => array(
        UNIT_PLANET_DENSITY => 8250,
        UNIT_PLANET_DENSITY_INDEX => PLANET_DENSITY_METAL_PERIDOT,
        UNIT_PLANET_DENSITY_RARITY => 5, // 8.00, // * 5,0	4,13223
        UNIT_PLANET_DENSITY_RICHNESS => PLANET_DENSITY_RICHNESS_GOOD,
        UNIT_RESOURCES => array(RES_METAL => 4.00, RES_CRYSTAL => 0.70, RES_DEUTERIUM => 0.70, ),
        UNIT_PLANET_DENSITY_MAX_SECTORS => 200,
      ),
      PLANET_DENSITY_METAL_RAW => array(
        ...
        UNIT_PLANET_DENSITY_RARITY => 1, // 40.00, // * 1,0	0,82645
        UNIT_PLANET_DENSITY_RICHNESS => PLANET_DENSITY_RICHNESS_PERFECT,
        UNIT_RESOURCES => array(RES_METAL => 8.00, RES_CRYSTAL => 0.30, RES_DEUTERIUM => 0.30, ),
        UNIT_PLANET_DENSITY_MAX_SECTORS => 999,
      ),
    ),
