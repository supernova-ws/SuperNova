...
/**
 * Class UBEUnitCombatList
 *
 * @method UBEUnitCombat offsetGet($offset)
 * @property UBEUnitCombat[] $_container
 */
class UBEUnitCombatList extends ArrayAccessV2 {
  ...
  public function init_from_UBEFleet(UBEFleet $UBEFleet) {
    foreach($UBEFleet->unit_list->_container as $unit_id => $UBEFleetUnit) {
      ...
      $this[$unit_id] = new UBEUnitCombat();
