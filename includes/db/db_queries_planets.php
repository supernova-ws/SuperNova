 ...
 * @return array
 */
function db_planet_by_vector_object($vector, $for_update = false, $fields = '*') {
  $planet_type = $vector->type == PT_DEBRIS ? PT_PLANET : $vector->type;
  $result = db_planet_by_gspt_safe($vector->galaxy, $vector->system, $vector->planet, $planet_type, $for_update, $fields);
