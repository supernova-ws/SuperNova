 ...
 */
function db_ally_get_by_id($id_ally) {
 ...
 * @return array|bool|mysqli_result|null
 */
function db_ally_get_by_name_or_tag($ally_tag, $ally_name) {
 ...
 * @param $ally_id
 */
function db_ally_update_ally_user($ally_user_id, $ally_id) {
 ...
 * @param $user
 */
function db_ally_request_delete_by_user($user) {
 ...
 * @return array|bool|mysqli_result|null
 */
function db_ally_get_by_tag($tag) {
 ...
 * @return array|bool|mysqli_result|null
 */
function db_ally_search_by_name_or_tag($ali_search_text) {
 ...
 * @return array|bool|mysqli_result|null
 */
function db_ally_request_count_by_id($ally) {
 ...
 * @param $ally
 */
function db_ally_update_texts($text_list, $allyTextID, $text, $ally) {
 ...
 * @param $user
 */
function db_ally_update_owner($idNewLeader, $user) {
 ...
 */
function db_ally_negotiation_delete($user, $alliance_negotiation_contr_ally_id) {
 ...
 * @return array|bool|mysqli_result|null
 */
function db_ally_negotiation_get_by_offer_id($offer_id) {
 ...
 * @param $offer_id
 */
function db_ally_negotiation_delete_by_offer_id($offer_id) {
 ...
 * @param $offer_id
 */
function db_ally_negotiation_update_status_1($offer_id) {
 ...
 * @param $user
 */
function db_ally_negotiatiion_delete_extended($negotiation, $user) {
  doquery(
 ...
 * @return array|bool|mysqli_result|null
 */
function db_ally_list_get_by_not_user_ally($user) {
 ...
 * @return array|bool|mysqli_result|null
 */
function db_ally_negotiation_list($user) {
  $query = doquery(
    "SELECT
    *,
 ...
 * @param $ally
 */
function db_ally_update_member_increase($ally) {
 ...
 * @param $ally
 */
function db_ally_update_member_decrease($ally) {
 ...
 * @param $ally
 */
function db_ally_update_member_set($i, $ally) {
 ...
 * @param $id_user
 */
function db_ally_request_delete_by_user_id($id_user) {
 ...
 * @return array|bool|mysqli_result|null
 */
function db_ally_get_members_by_user_as_ally(&$user) {
