...
class SnTemplate {
   ...
   * @return mixed
   */
  public static function getSkinPathTemplate($userSkinPath) {
...
//  pdump(microtime(true) - SN_TIME_MICRO, 'Header render started');
  ...
  public static function renderCss($is_login) {
    ...
    $standard_css = array();
    self::cssAddFileName('design/css/jquery-ui', $standard_css);
    self::cssAddFileName('design/css/global', $standard_css);
    $is_login ? self::cssAddFileName('design/css/login', $standard_css) : false;
    self::cssAddFileName(TEMPLATE_PATH . '/_template', $standard_css);
    self::cssAddFileName(SN::$gc->theUser->getSkinPath() . 'skin', $standard_css);
    self::cssAddFileName('design/css/global_override', $standard_css);
...
//    'GLOBAL_DISPLAY_NAVBAR' => $showHeader,
  ...
  public static function gettemplate($files, $template = null, $template_path = null) {
    ...
    $templateName = SnTemplate::getSkinPathTemplate(SN::$gc->theUser->getSkinPath());
