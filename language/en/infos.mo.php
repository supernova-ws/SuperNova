...
//    ),
    ...
    ART_HEURISTIC_CHIP => array(
      ...
      'effect' => 'Уменьшает время текущего исследования в два раза (если до конца исследования осталось больше часа) или моментально заканчивает его (если до конца исследования осталось 1 час или меньше)', //. Если времени исследования осталось менее часа - остаток не переходит на следующий слот в очереди',
    ),
    ...
    ART_NANO_BUILDER => array(
      ...
      'effect' => 'Уменьшает время постройки/разрушения текущего здания на данной планете в два раза (если до конца процесса осталось больше часа) или моментально заканчивает его (если до конца процесса остался 1 час или меньше)', // . Если времени строительства осталось менее часа - остаток не переходит на следующий слот в очереди',
    ),
