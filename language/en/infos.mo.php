...
//    ),
    ...
    UNIT_PLANET_DENSITY => array(
      'description' => 'Средняя планетарная плотность (далее - просто "плотность") характеризует химический состав геосферы планеты. В частности, она очень точно предсказывает, какие соотношения добываемых поленых веществ.<br />
      ...
      В зависимости от плотности выделяют семь типов планет:
      <ul>
        <li>
          <span class="ok">Ледяные планеты</span> (плотность <span class="zero">менее 2000</span> кг/м&sup3;).
          Ядро таких планет состоит из водяного льда с небольшой примесью других веществ, мантия - из твердого метана, а литосфера - из кристаллического водорода.
          В подавляющем большинстве ледяные планнеты встречаются на периферии звездных систем. Впрочем, известны случаи, когда такие планеты обнаруживаются на низких орбитах.
          Обычно это гигантские астероиды, захваченные тяготением звезды, имеют свою быстро улетучивающуюся атмосферу из легких газов (водород и гелий) и гидросферу из жидкого водорода и метана. Существование такой планеты чрезвычайно коротко во вселенских масштабах, но для обнаружившего такую планету она послужит неисчерпаемым источником дейтерия.
          Из-за обилия водно-метанового льда и большого наличия водорода в различных состояних, на ледяных планетах <span class="ok">высокая добыча дейтерия</span>.
