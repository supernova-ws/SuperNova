...
$a_lang_array = (array(
  ...
  'fl_attack_error' => array(
    FLIGHT_ALLOWED                      => 'Fleet sent successfully',
    FLIGHT_VECTOR_NO_TARGET             => 'The specified destination does not exist',
    FLIGHT_PLAYER_OWN                   => 'cannnot attack own planet',
    FLIGHT_MISSION_IMPOSSIBLE           => 'The task cannot be performed in the specified destination',
    FLIGHT_MISSION_HOLD_NO_ALLY_DEPOSIT => 'No alliance depot on planet',
    FLIGHT_MISSION_RECYCLE_NO_DEBRIS    => 'No debris field here',
    FLIGHT_PLAYER_VACATION              => 'You cannot attack a player in Vacation Mode',
    FLIGHT_PLAYER_SAME_IP               => 'Cannot trade with players with same IP!<br>Interaction with players with the same IP could be banned',
    FLIGHT_PLAYER_BUFFING               => 'Injection - transfer of resources from weak to strong player - is forbidden by the rules',
    FLIGHT_PLAYER_ADMIN                 => 'You cannot attack the administrator',
    FLIGHT_PLAYER_NOOB                     => 'This player is too weak for you.',
    FLIGHT_PLAYER_VACATION_OWN             => 'You are in Vacation Mode',
    FLIGHT_MISSION_MISSILE_NO_SILO         => 'Too low of missile silo',
    FLIGHT_MISSION_MISSILE_NO_MISSILES     => 'You cannot attack without missiles',
    FLIGHT_SHIPS_NO_SHIPS                  => 'No fleet selected',
    FLIGHT_FLEET_NO_SLOTS                  => 'No fleet slots',
    FLIGHT_SHIPS_NOT_ENOUGH_OR_RESOURCES   => 'No ships',
    FLIGHT_SHIPS_NO_RECYCLERS              => 'No recyclers',
    FLIGHT_MISSION_SPY_NO_SPIES            => 'No spy probes',
    FLIGHT_SHIPS_NO_COLONIZER              => 'No colonyship',
    FLIGHT_MISSION_MISSILE_TOO_FAR         => 'Your missiles cannot reach this far',
    FLIGHT_MISSION_MISSILE_WRONG_STRUCTURE => 'You can only attack defence structures',
    FLIGHT_RESOURCES_FUEL_NOT_ENOUGH       => 'Not enough fuel to launch fleet',
    FLIGHT_RESOURCES_NOT_ENOUGH            => 'There is not enough resources for transport',
    FLIGHT_MISSION_ACS_NOT_EXISTS          => 'No ACS',
