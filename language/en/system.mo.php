...
// top bar
  ...
  'log_lost_email_code' => "Someone (possibly you) has requested a reset password on SuperNova Universe %4 . If you did not request reset password-then just ignore this email.\r\n\r\nFor password reset, go to the address \r\n%1$s?password_reset_confirm=1&confirm=%2$s\r\nor enter the confirmation code \"%2$s\" (WITHOUT THE DOUBLE QUOTES!) on the page %1$s This code will be valid up to %3$s. After the password reset you will need to request a new confirmation code",
  'log_lost_email_pass' => "You changed your password on the SuperNova Universe %s. The following line shows your new password:\r\n%s\r\nRemember it!",
