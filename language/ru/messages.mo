...
$lang = array_merge($lang, array(
  ...
  'msg_page_hint_class' => '<ul>
    <li>Категория "' . $lang['msg_class'][MSG_TYPE_OUTBOX] . '" содержит список отправленных вами сообщений И еще не удаленных адресатом.
    Вы не можете удалять сообщения данной категории</li>
    <li>Что бы удалить все сообщения определенной категории нажмите иконку удаления в соответствующей строке</li>
    <li>Удаление сообщений из категории "' . $lang['msg_class'][MSG_TYPE_NEW] . '" приведет к очистке почтового ящика</li>
    <li>Медленное соединение и/или большое количество сообщений в одной из категорий может
    привести к невозможности просмотра сообщений. В таком случае вам необходимо очистить почтовый ящик целиком
    или удалить все сообщения из категории, вызывающей проблемы</li>
  </ul>',
));
