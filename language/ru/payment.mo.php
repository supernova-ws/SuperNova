...
$a_lang_array = (array(
  ...
  'pay_msg_mm_purchase_incomplete' => 'Ваш платёж за %d единиц Метаматерии через сервис %s не завершен. Если вы считаете, что произошла ошибка - свяжитесь с Администрацией сервера',
