...
$lang['fl_attack_error'] = array(
  ATTACK_ALLOWED         => 'Атака разрешена',
  ...
  ATTACK_VACANCY         => 'Нельзя атаковать игрока, находящегося в режие отпуска!',
  ATTACK_SAME_IP         => 'ЗАЩИТА ОТ МУЛЬИАККАУНТОВ!<br>Взаимодействие с игроком с таким же IP невозможно!',
  ...
  ATTACK_NO_SHIPS        => 'Не хватает боевых единиц!',
...
$lang['fl_page1_hint']			= '<ul>
  <li>Продолжительность полета включает время на взлет/посадку флота - обязательную компоненту любого рейса, как далеко или близко он бы не совершался
  <li>Для создания, редактирования и удаления закладкок используйте пункт &quot;Закладки&quot; в левом меню
  <li>Что бы присоединится к боевому союзу кликните на названии любого доступного вам союза</ul>';

$lang['fl_page0_hint']				= '<ul>
  <li>
  <li>Для создания, редактирования и удаления закладкок используйте пункт &quot;Закладки&quot; в левом меню
  <li>Что бы присоединится к боевому союзу кликните на названии любого доступного вам союза</ul>';
