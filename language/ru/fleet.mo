...
$lang['fl_page5_hint']			= 
'<ul>
  <li>Отметьте галочками колонии, с которых хотите свезти ресурсы на текущую планету
  <li>Галочка в заголовке окна позволяет поставить или снять отметки сразу на всех колониях
