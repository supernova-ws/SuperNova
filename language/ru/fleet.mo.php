...
$a_lang_array = (array(
  ...
  'fl_attack_error'     => array(
    ...
    FLIGHT_MISSION_COLONIZE_NOT_PLANET      => 'Неправильный тип цели! При Колонизации флот нужно направлять на цель типа "Планета"',
    ...
    FLIGHT_MISSION_EXPLORE_KNOWN_SPACE      => 'Нельзя отправлять Экспедицию в известный космос! Выберите координаты планеты за пределами системы',
    ...
    FLIGHT_MISSION_MISSILE_DISABLED         => 'Нельзя отправлять "Ракетную атаку" со страницы отправки флотов! Используйте обзор Вселенной!',
    FLIGHT_MISSION_MISSILE_ONLY_ATTACK      => 'Неправильный состав флота! В миссию "Ракетная атака" можно отправлять только атакующие ракеты!',
    ...
    FLIGHT_SHIPS_ONLY_MISSILES           => 'Только флот, состоящий из МПР (без кораблей или "Перехватчиков"), может быть отправлен в миссию "Ракетная атака"',
    ...
    FLIGHT_CAPTAIN_ON_OTHER_PLANET => 'Выбранный Капитан находится на другой планете',
    ...
    FLIGHT_VECTOR_BEYOND_SYSTEM     => 'Пункт назначения этой миссии не может находится за пределами системы - проверьте координаты планетарной системы',
    FLIGHT_VECTOR_NO_TARGET         => 'Указанный пункт назначения не существует или недавно покинут владельцем',
    FLIGHT_VECTOR_TARGET_NOT_EXISTS => 'Указанный пункт назначения не существует во Вселенной',
    FLIGHT_VECTOR_TARGET_DESTROYED  => 'Указанный пункт назначения уничтожен или недавно покинут владельцем',
