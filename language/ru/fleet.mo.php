...
$a_lang_array = (array(
  ...
  'fl_attack_error'     => array(
    ...
    FLIGHT_UNIT_NOT_ONLY_SPIES           => 'В миссию "Шпионаж" может быть отправлен флот, состоящий из шпионских зондов - И ТОЛЬКО из шпионских зондов',
    ...
    FLIGHT_VECTOR_NO_TARGET     => 'Указанный пункт назначения не существует',
