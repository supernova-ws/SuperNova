...
$lang = array_merge($lang, array(
  ...
  'info' => array(
    ...
    MRC_DESTRUCTOR => array(
      ...
      'effect' => 'Позволяет строить на верфи корабль .',
    ),
    ...
    MRC_ASSASIN => array(
      'description' => 'Ассасин - доверенный убийца Императора. Но это не единственное его качество. Вместе с Разрушителем, Ассасин разработал . Центральный компьютер корабля настроен на ДНК Ассасина. Поэтому он - единственный человек, способный управлять этим кораблем',
      'effect' => 'Возможность строить  на верфи',
    ),
