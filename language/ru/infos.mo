...
$lang = array_merge($lang, array(
  ...
  'info' => array(
    ...
    MRC_TECHNOLOGIST => array(
      ...
      'effect' => 'к добыче металла, кристаллов и дейтерия, к выработке электроэнергии на солнечной и термоядерной станциях за каждый уровень.<br>С 5-го уровня позволяет строить термоядерную электростанцию',
    ),
    ...
    UNIT_PLAN_STRUC_MINE_FUSION  => array(
      'description' => 'Позволяет строить на планетах строение "Термоядерная Электростанция"',
      'effect' => 'Позволяет строить на планетах строение "Термоядерная Электростанция"',
    ),

    UNIT_PLAN_SHIP_CARGO_SUPER  => array(
      'description' => 'Позволяет строить на верфях корабль "Супертранспорт"',
      'effect' => 'Позволяет строить на верфях корабль "Супертранспорт"',
    ),

    UNIT_PLAN_SHIP_CARGO_HYPER  => array(
      'description' => 'Позволяет строить на верфях корабль "Гипертранспорт"',
      'effect' => 'Позволяет строить на верфях корабль "Гипертранспорт"',
    ),

    UNIT_PLAN_SHIP_DEATH_STAR  => array(
      'description' => 'Позволяет строить на верфях корабль "Звезда Смерти"',
      'effect' => 'Позволяет строить на верфях корабль "Звезда Смерти"',
    ),

    UNIT_PLAN_SHIP_SUPERNOVA  => array(
      'description' => 'Позволяет строить на верфях крейсер класса "Сверхновая"',
      'effect' => 'Позволяет строить на верфях крейсер класса "Сверхновая"',
    ),

    UNIT_PLAN_DEF_SHIELD_PLANET  => array(
      'description' => 'Позволяет строить на планете защитное сооружение "Планетарная защита"',
