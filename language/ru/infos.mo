...
$lang = array_merge($lang, array(
  ...
  'info' => array(
    ...
    TECH_ENIGNE_ION => array(
      'description' => "Принцип работы ионного двигателя заключается в ионизации газа и его разгоне электростатическим полем. При этом, благодаря высокому отношению заряда к массе, становится возможным разогнать ионы до очень высоких скоростей (вплоть до 210 км/с по сравнению с 3—4,5 км/с у химических ракетных двигателей). Таким образом, в ионном двигателе можно достичь очень большого удельного импульса. Это позволяет значительно уменьшить расход реактивной массы ионизированного газа по сравнению с расходом реактивной массы в химических ракетах, но требует больших затрат энергии. Поэтому все корабли на ионных двигателях несут на борту дополнительный термоядерный реактор, работающий исключительно на двигательную установку и отличаются повышенным расходом дейтрия. Наиболее рационально устанавливать двигатели данного типа либо на легкие корабли, которые должны разгонятся быстро, либо на тяжелые корабли, ускорение которых не имеет значение. Именно поэтому номенклатура кораблей с данной установкой включает {$lang['tech'][SHIP_CARGO_SMALL]} (после разработки 5-го уровня двигателей), {$lang['tech'][SHIP_CARGO_SUPER]}, {$lang['tech'][SHIP_FIGHTER_HEAVY]}, {$lang['tech'][SHIP_DESTROYER]}, {$lang['tech'][SHIP_COLONIZER]} и {$lang['tech'][SHIP_BOMBER]} (до разработки технологии {$lang['tech'][TECH_ENGINE_HYPER]} 8-го уровня). Так же эти двигатели устанавливаются на межпланетные ракеты - в их случае реактор настраивается так, что бы остатки топлива являются вспомогательным ВВ.",
    ...
    SHIP_CARGO_BIG => array(
      ...
      'description_short' => 'Дальнейшее развитие малых транспортов позволило создать корабли, обладающие большей вместительностью и, благодаря более развитому двигателю, способными передвигаться быстрее, чем малый транспорт, до тех пор, пока на малых транспортах не устанавливаются ионные двигатели 5-го уровня'
    ),
