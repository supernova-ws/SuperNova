...
$lang = array_merge($lang, array(
  ...
  'info' => array(
    ...
    MRC_FORTIFIER => array(
      ...
      'effect' => 'ко времени постройки защитных сооружений и ракет за каждый уровень.<br />
        +10% за каждый уровень к атаке, броне и щитам хозяина планеты при обороне<br />
        С 3-го уровня позволяет строить Планетарную защиту'
    ),
