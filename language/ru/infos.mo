...
// ----------------------------------------------------------------------------------------------------------
// Officiers !
$lang['info'][MRC_GEOLOGIST]['description']	= 'Геолог - это признанный эксперт в астроминералогии и кристаллографии. Со своей командой металлургов и химиков он поддерживает межпланетные правительства при разработке новых источников ресурсов и оптимизации их очистки.<br><br><font color="red">+5% добычи Рудника и Синтезаторов. Максимальный уровень: 20.</font>';
$lang['info'][MRC_ADMIRAL]['description']	= 'Адмирал - это испытанный войной ветеран и гениальный стратег. Даже в самых горячих боях он не теряет обзора и поддерживает контакт с подчинёнными ему адмиралами. Мудрый правитель может полностью положиться на него в бою и тем самым использовать для боя больше кораблей.<br><br><font color="red">+5% к харктеристикам кораблей и защиты. Максимальный уровень: 20.</font>';
$lang['info'][MRC_POWERMAN]['description']	= 'Специалист по управлению энергией. В мирное время он повышает уровень энергетических сетей на колониях.<br><br><font color=red>+5% энергии. Максимальный уровень: 10.</font>';
$lang['info'][MRC_CONSTRUCTOR]['description']	= 'Конструкторы - это гениальные учёные, и их всегда можно найти там, где заканчивается грань технически возможного. Их код никогда не сможет разгадать ни один нормальный человек, и одним своим присутствием они вдохновляют учёных империи.<br><br><font color="red">Увеличивает скорость производства кораблей на 5%. Максимальный уровень: 10.</font>';
$lang['info'][MRC_ARCHITECT]['description']	= 'Архитектор - современнейший строитель Империи. Его ДНК была подвергнута мутациям, что обеспечило ему экстраординарный склад ума и сверхчеловеческую силу. Архитектор в одиночку может спроектировать и построить целый город.<br><br><font color="red">-10% к времени строительства. Макс. уровень : 3</font>';
$lang['info'][MRC_ACADEMIC]['description']	= 'Академики являются участниками Гильдии Технократов. Их склад ума и учёные степени позволяют им превосходить в своих деяниях даже Конструкторов. Они специализируются в области технологического прогресса.<br><br><font color="red">-10% к времени исследования. Макс. уровень : 3</font>';
$lang['info'][MRC_STOCKMAN]['description']	= 'Карго-мастер является высококласным специалистом по складированию. Его гений позволяет извлечь максимум из хранилищ ресурсов, увеличивая их эффективную емкость за пределы, предусмотренные строителями.<br><br><font color="red">+50% к хранилищу. Макс. уровень : 2</font>';
$lang['info'][MRC_FORTIFIER]['description']	= 'Фортификатор - армейский инженер-специалист. Его глубокие познания в области оборонительных систем позволяют сократить сроки строения систем обороны Империи.<br><br><font color="red">-50% к времени строительства защиты. Максимальный уровень: 2</font>';
$lang['info'][MRC_DEFENDER]['description']	= 'Количество работ, проведенных Вами по укреплению Империи даёт Вам шанс построить Планетарную защиту. Планетарная защита - ультрасовременное решение во всех технологических отраслях Империи.<br><br><font color="red">Возможность строить Планетарную защиту</font>';
$lang['info'][MRC_SPY]['description']	= 'Шпион - загадочнейшая персона Империи. У него сотни лиц, тысячи личностей и миллион идей, касающихся маскировки сооружений, оборонительных сетей и флота. Все, кто видел его настоящее лицо ныне мертвы.<br><br><font color="red">+1 уровень шпионажа. Максимальный уровень: 2</font>';
$lang['info'][MRC_COORDINATOR]['description']	= 'Координатор является экспертом в управлении флотами. Его познания позволяют выжать максимум из системы управления флота.<br><br><font color="red">+3 свободных места к флоту. Максимальный уровень: 2</font>';
$lang['info'][MRC_DESTRUCTOR]['description']	= 'Разрушитель - беспощадный офицер. Он наводит порядок на планетах Империи зверскими методами. Так же Уничтожитель разработал технологию производств Звезд Смерти.<br><br><font color="red">Позволяет строить ЗС на верфи. Макс. уровень: 1</font>';
$lang['info'][MRC_NAVIGATOR]['description']	= 'Навигатор - гений в расчете траекторий полета флотов. Его знания законов варп-пространства, устройства джамп-привода и технологий всех существующих типов двигателей позволяет увеличить скорость полета кораблей.<br><br><font color="red">+25% к скорости кораблей. Макс. уровень : 3</font>';
$lang['info'][MRC_ASSASIN]['description']	= "Ассасин - доверенный убийца Императора. Но это не единственное его качество. Вместе с Разрушителем, Ассасин разработал {$lang['tech'][216]}. Центральный компьютер корабля настроен на ДНК Ассасина. Поэтому он - единственный человек, способный управлять этим кораблем.<br><br><font color=\"red\">Возможность строить {$lang['info'][216]['name']} на верфи</font>";
$lang['info'][MRC_EMPEROR]['description']	= 'Император - Ваш личный помощник и заместитель. Точность его докладов и дотошная пунктуальность во всём - его лучшие качества, способные осуществлять тотальный контроль над Империей.<br><br><font color="red">Позволяет изменить характеристики Императора</font>';
