...
$lang['info'][612]['description']	= "Разрушитель это самый безжалостный офицер. Он наводит ужас на планеты ради удовольствия. Разработал методы по производству Звезды Смерти.<br><br><font color=red>Позволяет строить ЗС на верфи.</font>";
...
$lang['info'][614]['description']	= "<br><br>Убийца - личный помощник Императора. Его жестокость и справедливость схожи с теми же качествами Уничтожителя, его власть простирается на все отрасли деятельности Империи.<br><br><font color=\"red\">Возможность строить {$lang['info'][216]['name']} на верфи</font>";
$lang['info'][615]['name']				= $lang['tech'][615];
$lang['info'][615]['description']	= "<br><br>Император - Ваш личный помощник и заместитель. Точность его докладов и дотошная пунктуальность во всём - его лучшие качества, способные осуществлять тотальный контроль над Империей.<br><br><font color=\"red\">Позволяет изменить характеристики Императора</font>";
?>
