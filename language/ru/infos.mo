...
$lang = array_merge($lang, array(
  ...
  'info' => array(
    ...
    SHIP_SUPERNOVA => array(
      ...
      'description_short' => ' - флагман космического флота Империи. Огромная стоимость постройки с лихвой компенсируется ужасающей огневой мощью и продвинутой защитой. Один корабль такого класса способен в одиночку разгромить средний флот.',
    ),
    ...
    MRC_TECHNOLOGIST => array(
      ...
      'effect' => 'к добыче металла, кристаллов и дейтрия, к выработке электроэнергии на солнечной и термоядерной станциях за каждый уровень.<br>С 5-го уровня позволяет строить термоядерную электростанцию',
    ),

    MRC_ENGINEER => array(
      'effect' => 'ко времени постройки зданий и кораблей за каждый уровень',
      'description' => 'Инженер - современнейший строитель Империи. Его ДНК была подвергнута мутациям, что обеспечило ему экстраординарный склад ума и сверхчеловеческую силу. Архитектор в одиночку может спроектировать и построить целый город.',
    ),
    ...
    MRC_FORTIFIER => array(
      ...
      'effect' => 'ко времени постройки защитных сооружений и ракет за каждый уровень.<br />        +10% за каждый уровень к атаке, броне и щитам хозяина планеты при обороне<br />        С 3-го уровня позволяет строить Планетарную защиту',
    ),
    ...
    MRC_ASSASIN => array(
      'description' => 'Ассасин - доверенный убийца Императора. Но это не единственное его качество. Вместе с Разрушителем, Ассасин разработал новый класс крейсеров - "Сверхновая". Центральный компьютер корабля настроен на ДНК Ассасина. Поэтому он - единственный человек, способный управлять этим кораблем',
      'effect' => 'Возможность строить на верфи крейсера класса "Сверхновая"',
    ),
    ...
    RES_ENERGY => array(
      'description' => 'Электроэнергия - единный универсальный вид энергии, которые используется повсеместно. На планетах она обычно вырабатывается солнечными электростанциями и солнечными спутниками. На особо далеких от солнца холодных планетах и космических кораблях электроэнергия вырабатывается дейтриевыми термоядерными реакторами',
      'effect' => '',
    ),

    RES_DARK_MATTER => array(
      'description' => 'Тёмная Материя - необнаружиая стандартными методами небарионная материя, на которую приходится 23% массы Вселенной. Из неё можно добывать невероятное количество энергии. Из-за этого, а так же из-за сложностей, связанных с её добычей, Темная Материя ценится очень высоко',
      'effect' => '',
    ),
