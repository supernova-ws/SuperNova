...
$lang['info'][2]['description']	= "Для синтеза кристаллов требуется примерно вдвое больше энергии, чем для добычи равного количества металла, поэтому он, соответственно, ценится больше. Кристаллы - основная составляющяя любой современных компьютеров и ключевой компонент варп-двигателей. Поэтому он требуется для всех кораблей и почти для всех зданий. Усовершенствование синтезатора увеличивает количество производимых кристаллов.";
