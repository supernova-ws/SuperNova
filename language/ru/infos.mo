...
$lang = array_merge($lang, array(
  ...
  'info' => array(
    ...
    SHIP_SUPERNOVA => array(
      ...
      'description_short' => "{$lang['tech'][SHIP_SUPERNOVA]} - флагман космического флота Империи. Огромная стоимость постройки с лихвой компенсируется ужасающей огневой мощью и продвинутой защитой. Один корабль такого класса способен в одиночку разгромить средний флот."
    ),
    ...
    MRC_DESTRUCTOR => array(
      ...
      'effect' => "Позволяет строить на верфи корабль {$lang['tech'][SHIP_DEATH_STAR]}."
    ),

    MRC_ASSASIN => array(
      'description' => "Ассасин - доверенный убийца Императора. Но это не единственное его качество. Вместе с Разрушителем, Ассасин разработал {$lang['tech'][SHIP_SUPERNOVA]}. Центральный компьютер корабля настроен на ДНК Ассасина. Поэтому он - единственный человек, способный управлять этим кораблем",
      'effect' => "Возможность строить {$lang['tech'][SHIP_SUPERNOVA]} на верфи"
    ),
