...
$lang = array_merge($lang, array(
  ...
  'ov_manage_page_hint' => '<li class="warning">ВНИМАНИЕ! При найме губернатора, отличного от текущего, предыдущий губернатор увольняется БЕЗ КОМПЕНСАЦИИ ТЕМНОЙ МАТЕРИИ, а уровень нового губернатора будет равен единице!  Поэтому планируйте развитие своей Империи, заранее подбирая губернатора для каждой конкретной планеты в зависимости от её планируемой роли!</li>  <li>Губернаторы - это наемники, управлюящие отдельной планетой и дающие определенные бонусы для данной планеты</li>  <li>Кликните на изображении губренатора в списке, что бы увидеть его описание и предоставляемые им бонусы</li>  <li>Что бы нанять конкретного губернатора кликните на надпись "Нанять"</li>  <li>Повторный найм текущего губрентатора увеличивает его уровень и, соответственно, планетарный эффект</li><li>Некоторые губернаторы имеют ограничения по уровню. Некоторые - нет</li>
  <li>Телепортация перемещает в новые координаты планету вместе с луной</li>
  ',

  'ov_gate_time_left' => 'Время до следующего прыжка',

  'ov_teleport' => 'Телепортировать',
  'ov_teleport_new_coordinates' => 'Новые координат',
  'ov_teleport_wrong_coordinates' => 'Неправильные координаты',
));
