...
//      'TABLE_FOOTER'  => '',
  ...
  'adm_mm_user_none' => 'Ошибка при поиске пользователя: не найдено пользователя с ID или именем %s',
  'adm_mm_user_added' => 'Количество ММ у пользователя [%s] (ID: %d) успешно изменено на %d ММ.',
