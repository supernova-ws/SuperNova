...
//      'TABLE_FOOTER'  => '',
  ...
  'adm_dm_user_added' => 'Количество ТМ у пользователя [%s] (ID: %d) успешно изменено на %s ТМ.',
  ...
  'adm_mm_user' => 'ID, имя игрока или основной емейл',
  'adm_mm_no_quant' => 'Укажите количество ММ (положительное - для начисления, отрицательное - для снятия)',
  'adm_mm_no_dest' => 'Укажите игрока для изменения ММ',
  'adm_mm_add_err' => 'Похоже во время начисления ММ произошла ошибка.',
  'adm_mm_user_none' => 'Ошибка при поиске пользователя: не найдено пользователя с ID, именем или емейлом "%s"',
  'adm_mm_user_added' => 'Количество ММ у пользователя [%s] (ID: %d) успешно изменено на %s ММ.',
  'adm_mm_user_conflict' => 'Ошибка при поиске пользователя: похоже, в БД есть пользователь и с таким именем, и с таким ID',
  ...
  'adm_dm_change_hint' => 'Сначала поиск идёт по ID, затем - по имени, затем - по емейлу',
