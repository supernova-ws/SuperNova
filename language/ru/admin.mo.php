...
//      'TABLE_FOOTER'  => '',
  ...
  'adm_dm_user_added' => 'Количество ТМ у пользователя [%2$d] "%1$s" успешно изменено на %3$s ТМ',
  ...
  'adm_mm_change_hint' => 'Сначала поиск идёт по ID, затем - по имени, затем - по емейлу',
