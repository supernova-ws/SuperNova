...
$lang = array_merge($lang, array(
  ...
  'eco_bld_page_hint' => '<li>Что бы посмотреть информацию об отдельном юните, достаточно навести на картинку курсор мышки<li>Клик на картинке выберет юнит. Повторный клик по тому же юниту отменит выбор<li>Подробное описание юнита и его характеристики можно узнать, кликнув на синюю иконку &quot;i&quot; с кругом в правом нижнем углу картинки<li>Построить здание можно либо кликнув на плюсик в правом верхнем углу картинки, либо нажав ссылку &quot;Построить&quot; в описании<li>Разрушить здание можно кликнув на минус в левом верхнем углу картинки, либо по соответствующей ссылке из описания',
  'eco_price' => 'Цена',
  'eco_left' => 'Остаток',
