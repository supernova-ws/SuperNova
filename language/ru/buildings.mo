...
$lang = array_merge($lang, array(
  ...
  'build_research_in_progress' => 'Данная лаборатория уже ведет исследование.',
  'eco_bld_page_hint' => '<li>Что бы посмотреть информацию об отдельном юните, достаточно навести на картинку курсор мышки
