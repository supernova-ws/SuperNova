...
$lang['info'] = (array(
    ...
    SHIP_SUPERNOVA => array(
      ...
      'description_short' => 'Крейсер класса &quot;Сверхновая&quot; - флагман космического флота Империи. Огромная стоимость постройки с лихвой компенсируется ужасающей огневой мощью и продвинутой защитой. Один корабль такого класса способен в одиночку разгромить средний флот.',
    ),
...
//    ),
    ...
    UNIT_PLAN_SHIP_SUPERNOVA  => array(
      'description' => 'Чертеж крейсера класса "Сверхновая"',
    ...
    RES_DARK_MATTER => array(
      'description' => 'Тёмная Материя - необнаружимая стандартными методами небарионная материя, на которую приходится 23% массы Вселенной. Из неё можно добывать невероятное количество энергии. Из-за этого, а так же из-за сложностей, связанных с её добычей, Тёмная Материя ценится очень высоко',
      'effect' => '',
    ),
    ...
    UNIT_PLANET_DENSITY => array(
      ...
      <ul>
        <li>
          ...
          Из-за обилия водно-метанового льда и большого наличия водорода в различных состояних, на ледяных планетах <span class="ok">очень высокая добыча дейтерия</span>.
