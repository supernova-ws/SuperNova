...
$lang['info'] = (array(
    ...
    MRC_ENGINEER => array(
      ...
      'effect' => 'к скорости постройки зданий и кораблей за каждый уровень',
    ),
    ...
    MRC_FORTIFIER => array(
      ...
      'effect' => 'к скорости постройки защитных сооружений и ракет за каждый уровень.<br />+10% за каждый уровень к атаке, броне и щитам хозяина планеты при обороне',
    ),
...
//    ),
    ...
    RES_DARK_MATTER => array(
      'description' => 'Тёмная Материя - необнаружиая стандартными методами небарионная материя, на которую приходится 23% массы Вселенной. Из неё можно добывать невероятное количество энергии. Из-за этого, а так же из-за сложностей, связанных с её добычей, Тёмная Материя ценится очень высоко',
      'effect' => '',
    ),
