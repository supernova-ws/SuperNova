...
//  'neededpass' => 'Пароль',
  ...
  'log_lost_description1' => 'Введите основной e-mail, на который зарегестрирован Ваш аккаунт. На него будет отправлена письмо с кодом подтверждения для сброса пароля',
