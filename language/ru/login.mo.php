...
$a_lang_array = (array(
  ...
  'log_lost_description2' => 'Если у Вас есть код подтверждения - введите его ниже и нажмите кнопку "Сбросить пароль". На Ваш e-mail будет отправлено письмо с новым паролем<br /><br />
    ...
    Если и там нет письма - напишите письмо Администрации сервера на адрес <span class="ok">' . classSupernova::$config->server_email . '</span>',
  ...
  'login_account_name_or_email' => 'Имя аккаунта или е-мейл',
