...
$lang['thanksforregistry'] 	= 'Поздравляем вас с успешной регистрацией! Теперь вы можете войти в игру, использую свои имя и пароль. Удачной игры! <a href=./>Вернуться на главную</a>';
