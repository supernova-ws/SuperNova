...
$lang['thanksforregistry'] 	= 'Поздравляем вас с успешной регистрацией! Теперь вы можете войти в игру, использую свои имя и пароль. Удачной игры! <a href=http://ogame.triolan.com.ua/>Вернуться на главную</a>';
