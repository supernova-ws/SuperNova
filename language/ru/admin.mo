...
$lang = array_merge($lang, array(
  ...
  'adm_upd_register_hint' => '
    Регистрация сервера нужна для ряда запросов к серверу обновлений. При регистрации передается минимум информации, необходимой для идентификации сервера. В частности, передается:
    <ul>
      <li>Полный URL сервера - т.е. HTTP-адрес и подкаталог сервера. Например: http://myserver.com/myfolder/. Это необходимо для первичной идентификации сервера. Полный путь необходим для того, что бы различать несколько копий СверхНовой, установленных на одном IP или домене</li>
      <li>Внутреннее название сервера. Используется для подстановки в сообщения.</li>
    </ul>
    Зачем вообще регистрировать свой сервер? В будующем планируется ряд возможностей, которые буду доступны только зарегистрированным серверам. В их число входит (отсортированы по запланированным срокам реализации):
    <ul>
     ...
     <li>прямой чат с разработчиками движка</li>
     <li>удаленная диагностика сервера</li>
     <li>и многое другое</li>
    </ul>
    Зачем регистрировать свой сервер прямо сейчас?
    <ul>
      <li>Администраторы зарегестрированных серверов могут рассчитывать на дополнительное внимание разработчиков при диагностике проблем серверов и обработке багрепортов.</li>
