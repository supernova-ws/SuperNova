...
$lang = array_merge($lang, array(
  ...
  'adm_opt_ver_check' => 'Проверка версии игры',
  'adm_opt_ver_check_hint' => 'Проверка версии выполняется исключительно в ручном режиме по нажатию кнопки "Проверить версию". При этом передаются только анонимные данные - текущая версия БД, номер релиза и версия игры',
  'adm_opt_ver_check_do' => 'Проверить версию',

  'adm_opt_ver_response' => array(
    SNC_VER_ERROR_CONNECT => 'Ошибка проверки версии. Игра не смогла свзаться с сервером проверки версий. Убедитесь, что у вас установлен и активизорван в PHP CURL или что в настройках PHP разрешен доступ к удаленным серверам',
    SNC_VER_ERROR_SERVER => 'Ошибка сервера проверки версий. Срочно уведомите разработчика!',
