...
$lang = array_merge($lang, array(
  ...
  'sys_dark_matter_description_text' => 'Тёмная Материя - это внутриигровой ресурс, за счет которой в игре вы можете совершать различные операции:
    <ul>
      ...
      <li>Покупать Чертежи</li>
      <li>Покупать Артефакты</li>
      <li>...и многое, многое другое</li>
    </ul>',
  'sys_dark_matter_obtain_header' => 'Где взять Темную Материю?',
  'sys_dark_matter_obtain_text' => 'Вы получаете Темную Материю в процессе игры: набирая опыт за рейды на чужие планеты, исследование новых технологий, а так же за постройку и разрушение зданий.
...
// top bar
  ...
  'sys_dark_matter_desc' => 'Тёмная материя - необнаружиая стандартными методами небарионная материя, на которую приходится 23% массы Вселенной. Из неё можно добывать невероятное количество энергии. Из-за этого, а так же из-за сложностей, связанных с её добычей, Темная Материя ценится очень высоко.',
