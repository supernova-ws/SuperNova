...
//  'sys_tran_mess_owner' 		=> 'Один из ваших флотов достигает планеты %s %s и доставляет %s %s, %s  %s и %s %s.',
  ...
  'log_lost_email_code' => 'Кто-то (может быть Вы) запросил сброс пароля во Вселенной %4 игры Сверхновая. Если Вы не запрашивали сброс пароля - просто проигнорируйте это письмо.\r\n\r\nДля сброса пароля перейдите по адресу \r\n%1$s?password_reset_confirm=1&confirm=%2$s\r\n или введите код подтверждения "%2$s" (БЕЗ ДВОЙНЫХ КАВЫЧЕК!) на странице %1$s\r\n\r\nЭтот код будет действителен до %3$s. После указанного для сброса пароля Вам нужно будет запросить новый код подтверждения',
  'log_lost_email_pass' => "Вы сбросили пароль на сервере %s игры \'Сверхновая\'. В следующей строке указан Ваш новый пароль:\r\n%s\r\nЗапомните его!",
