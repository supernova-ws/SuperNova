...
$lang = array_merge($lang, array(
  'mrkt_title' => 'Черный рынок',
  'mrkt_merchant' => 'Торговец ресурсами',
  'mrkt_scraper' => 'Скупщик флота',
  'mrkt_call_cost' => 'Стоимость вызова',
  'mrkt_call' => 'Вызвать',
  'mod_ma_title' => 'Торговец',
  'mod_ma_typer' => 'Вы хотите продать',
  'mod_ma_rates' => 'Курсы обмена материалов 2/1/0.5',
  'mod_ma_buton' => 'Вызвать торговца',
  'mod_ma_noten' => 'Не достаточно',
  'mod_ma_done' => 'Обмен прошёл успешно!',
  'mod_ma_error' => 'Ошибка',
  'mod_ma_donet' => 'Обмен прошёл успешно!',
  'mod_ma_excha' => 'Обменять',
  'mod_ma_cours' => 'Курс обмена',
  'mod_ma_nbre' => 'Можно вводить только числа!!!',
  'eco_mrk_title' => 'Черный Рынок',
  'eco_mrk_services' => 'Услуги',
  'eco_mrk_dark_matter_short' => 'ТМ',
  'eco_mrk_service_cost' => 'Стоимость услуги',
  'eco_mrk_error_title' => 'Черный Рынок - Ошибка',
  ...
  'eco_mrk_trader' => 'Торговец ресурсами',
