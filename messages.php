  ...
  case 'show':
    ...
    while ($message_row = mysql_fetch_assoc($message_query))
    {
      $template->assign_block_vars('messages', array(
        ...
        'TEXT'           => in_array($message_row['message_type'], array(MSG_TYPE_PLAYER, MSG_TYPE_ALLIANCE)) ? nl2br(htmlspecialchars($message_row['message_text'])) : $message_row['message_text'],
