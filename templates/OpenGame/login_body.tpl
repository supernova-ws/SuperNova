...
.menupoint {
   ...
   /* height:4px; */
    ...
    padding-bottom:1px;
    padding-left:10px;
    background-image: url(../templates/OpenGame/img/point.png);
    background-repeat: no-repeat;
...
<div>
  ...
  <div id="rightmenu" class="rightmenu">
    ...
    <div id="content">
      ...
      <div id="text2">
        <div class="eingabe" align="center">
          <b>{log_online}: <font color="red">{online_users}</font> - {log_lastreg}: <font color="red">{last_user}</font> - {log_numbreg}: <font color="red">{users_amount}</font></b>
        </div>
      </div>
    </div>
  </div>
