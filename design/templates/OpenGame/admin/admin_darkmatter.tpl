<h2>{L_adm_dm_title}</h2>
<form action="" method="post">
  <table width="305"><tbody>
    <tr><td class="c" colspan="2">{L_adm_dm_title}</td></tr>
    <tr>
      <th>{L_adm_dm_user}</th>
      <th><input name="id_user" type="text" value="{id_user}"/></th>
    </tr>
    <tr><td class="c" colspan="2">{L_adm_dm_oruser}</td></tr>
    <tr>
      <th>{L_adm_dm_planet}</th>
    ...
    <tr><th colspan="2"><input type="Submit" value="{L_adm_apply}" /></th></tr>
  </tbody></table>
</form>
{message}
