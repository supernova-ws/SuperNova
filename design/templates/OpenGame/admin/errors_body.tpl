...
<table>
<tr>
<td class="c" colspan="6">{adm_er_list} [<a href="admin/errors.php?deleteall=yes">{adm_er_clear}</a>]</td>
</tr>
<tr>
<th>{adm_er_idmsg}</th>
<th>{adm_er_play}</th>
...
<!-- BEGIN error -->
    <tr>
      <th class=n><a href="admin/errors.php?detail={error.LOG_ID}"><u>{error.LOG_ID}</u></a></th>
      ...
      <th class=n><a href="admin/errors.php?delete={error.LOG_ID}"><img src="design/images/r1.png"></a></th>
    </tr>
