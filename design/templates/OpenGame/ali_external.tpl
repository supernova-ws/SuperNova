<br />
<form action="?mode=make" method="POST"><table width=519>
  <tr><td class="c" colspan=2>{make_alliance}</td></tr>
  <tr>
  ...
  <tr><th colspan=2><input type="submit" value="{make_alliance_owner}"></th></tr>
</table></form>
