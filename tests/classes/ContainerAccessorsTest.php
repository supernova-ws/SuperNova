...
class ContainerAccessorsTest extends PHPUnit_Framework_TestCase {
  ...
  public function test__set() {
    ...
    // Installing setter
    $accessors->set(P_CONTAINER_SET, 'p1', function (ContainerAccessors $that, $value) { $that->setDirect('p2', $value . '3'); });
//    $this->object->set('p1', P_CONTAINER_SET, function(Common\ContainerAccessors $that, $value) {$that->setDirect('p2', $value . '3');});
    ...
    $accessors->set(P_CONTAINER_GET, 'p2', function ($c) { return $c->p3 . '4'; });
    ...
    $accessors->set(P_CONTAINER_UNSET, 'p1', function (ContainerAccessors $that) { $that->unsetDirect('p2'); });
  ...
  public function test__isset() {
    ...
    $accessors->set(P_CONTAINER_GET, 'p2', function ($c) { return $c->p3; });
    $this->object->p4 = function ($c) {return $c->p5;};
    $accessors->set(P_CONTAINER_GET, 'p6', function ($c) { return $c->p7; });
