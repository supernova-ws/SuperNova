...
//    $this->object->set('test', P_CONTAINER_GET, null);
//    $this->assertAttributeEquals(array(), 'accessors', $this->object);
//
//    $lambda = function(){};
//    $this->object->set('test', P_CONTAINER_GET, $lambda);
...
//    $this->object->set('test', P_CONTAINER_GET, 1);
//  }
...
//    $this->object->setProperties(array('p1' => array()));
    ...
    // Installing setter
    $accessors->set('p1', P_CONTAINER_SET, function(ContainerAccessors $that, $value) {$that->setDirect('p2', $value . '3');});
//    $this->object->set('p1', P_CONTAINER_SET, function(Common\ContainerAccessors $that, $value) {$that->setDirect('p2', $value . '3');});
    $this->object->p1 = 'v2';
    // Setting value
    ...
    $accessors->set('p2', P_CONTAINER_GET, function($c) {return $c->p3 . '4';});
//    $this->object->set('p2', P_CONTAINER_GET, function($c) {return $c->p3 . '4';});
...
//    $this->object->set('p1', P_CONTAINER_UNSET, function(Common\ContainerAccessors $that) {$that->unsetDirect('p2');});
    $accessors->set('p1', P_CONTAINER_UNSET, function(ContainerAccessors $that) {$that->unsetDirect('p2');});
  ...
  public function test__isset() {
    ...
    $accessors->set('p2', P_CONTAINER_GET, function($c) {return $c->p3;});
//    $this->object->set('p2', P_CONTAINER_GET, function($c) {return $c->p3;});
    $this->object->p4 = function ($c) {return $c->p5;};
//    $this->object->set('p6', P_CONTAINER_GET, function($c) {return $c->p7;});
    $accessors->set('p6', P_CONTAINER_GET, function($c) {return $c->p7;});
